  ...
  return (
    ...
    >
      <p className="text-xs text-slate-500">
        Build any shape by adding/subtracting rectangles. Turn on{' '}
        <span className="font-medium text-slate-600">Edit shape</span> in the diagram to drag &amp;
        resize them directly. New rectangles appear to the right so they're always visible.
      </p>
      {rects.map((r, i) => {
        ...
        return (
          <div
            ...
            className={`cursor-pointer rounded border p-2 ${
              selected ? 'border-sky-500 ring-1 ring-sky-300' : 'border-slate-200'
            }`}
          >
